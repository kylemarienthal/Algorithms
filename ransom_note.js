...
//this has linear time complexity due to only having 2 regular loops. they aren't nested so its runtime is directly related to how many indices the array has. a nested loop makes it exponentially longer. Big "O" notation: O(n+m) or O(n) + O(m). n and m are the loops.
